...
local MainSection = Main:NewSection("GUI'S")
...
MainSection:NewButton("Speed Legends", "OP GUI", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/1iMHrZ50", true))()
end)


MainSection:NewButton("DeepWoken", "OP GUI", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/w8qQ07Pm", true))()
end)


MainSection:NewButton("KAT", "GUI", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/CriShoux/OwlHub/master/OwlHub.txt"))();
end)


MainSection:NewButton("Rush Point", "OP GUI", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/noobscripter38493/Rush-point/main/RUSH%20POINT!!!!!.lua"))()
end)


MainSection:NewButton("Breaking Point", "OP GUI", function()
...
MainSection:NewButton("Hood Modded", "OP GUI", function()
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Rippeed/DaHoodinary/main/chariotsware"))()
end)


MainSection:NewButton("Arsenal(KEY)", "OP GUI", function()
